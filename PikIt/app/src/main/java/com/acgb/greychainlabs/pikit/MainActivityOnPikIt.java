...
//    }
    ...
    public void addListenerOnProfileButton(View v) {

        button = (ImageButton) findViewById(R.id.account);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // open a new activity to the pin
                Intent intent = new Intent(MainActivityOnPikIt.this, profile.class);
                startActivity(intent);
